...
public class UserStatistics {
    ...
    public UserStatistics merge(UserStatistics that){
        assert(emailAddress.equals(that.getEmailAddress()));

        UserStatistics newUserStatistics = new UserStatistics();
        newUserStatistics.setEmailAddress(emailAddress);
        newUserStatistics.setNumberOfFlights(numberOfFlights + that.getNumberOfFlights());
        newUserStatistics.setTotalFlightDuration(totalFlightDuration.plus(that.getTotalFlightDuration()));
