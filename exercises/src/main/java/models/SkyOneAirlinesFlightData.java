...
public class SkyOneAirlinesFlightData {
    ...
    public FlightData toFlightData(){
        return new FlightData(this.getEmailAddress(), this.getFlightDepartureTime(), this.getIataDepartureCode(), 
        this.getFlightArrivalTime(), this.getIataArrivalCode(), this.getFlightNumber(), this.getConfirmation());
    }
}